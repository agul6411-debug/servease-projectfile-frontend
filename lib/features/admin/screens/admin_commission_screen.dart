...
import 'package:frontfile_servease/features/admin/services/admin_commission_service.dart';
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.network(
                      '${AppConfig.baseUrl}/uploads/commission/${data['screenshot']}',
                      fit: BoxFit.cover,
    ...
    showDialog(
      ...
      builder: (_) => Dialog(
        child: ClipRRect(
          borderRadius: BorderRadius.circular(12),
          child: Image.network(
            '${AppConfig.baseUrl}/uploads/commission/$filename',
            fit: BoxFit.contain,
          ),
        ),
      ),
