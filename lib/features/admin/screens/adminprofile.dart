...
import 'package:frontfile_servease/features/admin/services/adminprofileservice.dart';
...
class _AdminProfileState extends State<AdminProfile> {
  ...
  Future<void> fetchProfile() async {
    final adminId = GetStorage().read('user_id') ?? 1;
    final result = await service.getProfile(adminId);
    if (result != null) {
      setState(() {
        profile = result;
                                        ...
                                        ? ClipOval(
                                            child: Image.network(
                                              profile!.profileImage!.startsWith('http')
                                                  ...
                                                  : "${AppConfig.baseUrl}${profile!.profileImage!}",
                                              width: 104,
                                              height: 104,
                                              fit: BoxFit.cover,
                                            ),
