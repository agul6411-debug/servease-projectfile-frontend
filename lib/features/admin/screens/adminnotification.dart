...
class _AdminNotificationState extends State<AdminNotification> {
  static String get _base => "${AppConfig.baseUrl}/api/admin/notifications";
  ...
  Future<void> _sendNotification() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Notification failed: ${res.statusCode}'),
            backgroundColor: Colors.red,
          ),
        );
      }
  ...
  Future<void> _confirmClearAll() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'This will delete all notifications for all users (customers and providers). This cannot be undone.',
        ),
        actions: [
          TextButton(
