...
class _SignInFormState extends State<_SignInForm> with TickerProviderStateMixin {
  ...
  final box = GetStorage(); // ✅ FIXED: GetStorage instance token save karne ke liye
  ...
  void _handleSignIn() async {
    ...
    // ✅ FIXED: "name" field check hata diya — login ke liye sirf email + password chahiye
    ...
    try {
      ...
      if (result['success'] == true) {
        // ✅ FIXED: token aur user info GetStorage mein save karna
        // (pehle missing tha, isi liye AuthMiddleware hamesha sign-in pe wapas bhej deta tha)
        await box.write('token', result['token']);
        await box.write('role', result['role']);
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                // Email Field
                // ✅ FIXED: "Name" field hata diya — login form mein zarurat nahi thi
                TextField(
