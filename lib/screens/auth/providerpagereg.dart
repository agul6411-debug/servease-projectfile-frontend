...
import 'package:projectfile/services/providerpagereg_service.dart';
...
class _ProviderPageregState extends State<ProviderPagereg> {
  ...
  InputDecoration _dec({
    ...
    return InputDecoration(
      ...
      prefixIcon: Icon(icon, color: Color(0xFFBBBBBB), size: 18),
      suffixIcon: suffix,
      filled: true,
                            ...
                            SizedBox(
                              ...
                              child: DecoratedBox(
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: Color(0xFF4CAF50).withAlpha(89),
                                      blurRadius: 12,
                                      offset: const Offset(0, 4),
                                    ),
                                  ],
                                ...
                                child: ElevatedButton(
                                  ...
                                  onLongPress: _isLoading
                                      ? null
                                      : () => _showSnack(
                                          'Long press detected! This is a hidden feature.',
                                        ),
