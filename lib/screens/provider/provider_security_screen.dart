                ...
                children: [
                  Row(children: [
                    Container(
                      ...
                      child: const Icon(Icons.help_outline, color: Colors.orange, size: 18),
                    ),
                    const SizedBox(width: 10),
                  ...
                  OutlinedButton.icon(
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const ProviderForgotPasswordScreen()),
                    ),
...
class _ProviderForgotPasswordScreenState extends State<ProviderForgotPasswordScreen> {
  ...
  Future<void> _sendReset() async {
    ...
    final result = await ProviderApiService.forgotPassword(_emailCtrl.text.trim());
    setState(() {
      _isSending = false;
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.email_outlined, size: 18, color: AppColors.mutedForeground),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: const Icon(Icons.mark_email_read_outlined, color: AppColors.secondary, size: 40),
        ),
        const SizedBox(height: 24),
        ...
        Text(
          ...
          style: const TextStyle(fontSize: 13, color: AppColors.mutedForeground, height: 1.5),
        ),
        const SizedBox(height: 28),
        ElevatedButton(
