...
import 'package:frontfile_servease/services/admin_security_service.dart';
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.network(
                      'http://localhost:3000/uploads/security/${data['screenshot']}',
                      fit: BoxFit.cover,
    ...
    showDialog(
      ...
      builder: (_) => Dialog(
        child: ClipRRect(
          borderRadius: BorderRadius.circular(12),
          child: Image.network(
            'http://localhost:3000/uploads/security/$filename',
            fit: BoxFit.contain,
          ),
        ),
      ),
