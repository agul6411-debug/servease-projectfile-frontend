...
class AppColors {
  ...
  static const Color sidebarPrimary           = Color(0xFFE8845A);  // orange accent on sidebar
  ...
  return base.copyWith(
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: WidgetStateProperty.resolveWith((states) =>
        states.contains(WidgetState.selected) ? AppColors.primaryLight : Colors.grey.shade300),
    ),
  );
}
